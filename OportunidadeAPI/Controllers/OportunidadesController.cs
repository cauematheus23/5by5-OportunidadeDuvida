...
namespace OportunidadeAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class OportunidadesController : ControllerBase
    {
        private readonly OportunidadeAPIContext _context;

        public OportunidadesController(OportunidadeAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Oportunidade>> PostOportunidade(Oportunidade oportunidade)
        {
          if (_context.Oportunidade == null)
          {
              return Problem("Entity set 'OportunidadeAPIContext.Oportunidade'  is null.");
          }
